const config = {
	...
	skills: [
		{
			heading: 'Languages',
			items: ['TypeScript', 'JavaScript', 'GoLang', 'Python', 'C++']
		},
		{
		...
		{
			heading: 'Misc',
			items: ['Docker', 'MongoDB', 'PostgreSQL', 'Redis', 'Git', 'Bash']
		}
	],
	contact: [
		{
			name: 'LinkedIn',
			link: 'https://www.linkedin.com/in/anshgoyal31/'
		},
		{
			name: 'GitHub',
			link: 'https://github.com/anshg1214'
		},
		{
			name: 'Telegram',
			link: 'https://t.me/anshgoyal/'
		}
	],
	email: 'ansh@anshgoyal.com',
	calendly: 'https://calendly.com/anshgoyal/30min'
};
